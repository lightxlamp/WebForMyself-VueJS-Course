export const RUSSIAN_TRANSLATIONS = {
  text: {
    ...
    emailIsRequiredField: "Электронный адрес - обязательное поле",
    passwordIsRequiredField: "Пароль - обязательное поле",
    emailIncorrectFormat: "Некоректный формат адреса",
    passwordShouldBeAtLeast: "Пароль должен быть не меньше 6ти символов",
    passwordConfirmationIsRequired: "Подтверждающий пароль - обязательное поле",
